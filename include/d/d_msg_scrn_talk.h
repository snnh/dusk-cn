...
struct dMsgScrnTalk_c : public dMsgScrnBase_c {
    ...
    void dotAnimeInit();
    void dotAnimeMove();
    void setSelectString(char DUSK_CONST*, char DUSK_CONST*, char DUSK_CONST*) override;
    void setSelectRubyString(char DUSK_CONST*, char DUSK_CONST*, char DUSK_CONST*) override;
    bool isSelect();
